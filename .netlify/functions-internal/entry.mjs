...
import {
  s as server_default,
  f as deserializeManifest,
} from './chunks/astro.3ca4c4a2.mjs'
import { _ as _page0 } from './chunks/pages/all.4f0046fd.mjs'
import 'mime'
import 'cookie'
import 'html-escaper'
import 'kleur/colors'
...
const _manifest = Object.assign(
  deserializeManifest({
    ...
    routes: [
      {
        file: '',
        links: ['_astro/index.9abdab7b.css'],
        scripts: [],
        routeData: {
          route: '/',
          type: 'page',
    ...
    markdown: {
      ...
      gfm: true,
      smartypants: true,
      contentDir: 'file:///Users/adrian/webdev/adrian-burkhart/src/content/',
    },
    pageMap: null,
    propagation: [],
    renderers: [],
    entryModules: {
      ...
      '/Users/adrian/webdev/adrian-burkhart/src/components/Counter':
        '_astro/Counter.ee4cf6ad.js',
      '@astrojs/react/client.js': '_astro/client.38423ee9.js',
      'astro:scripts/before-hydration.js': '',
    },
    assets: [
      '/_astro/index.9abdab7b.css',
      '/favicon.svg',
      '/_astro/Counter.ee4cf6ad.js',
      '/_astro/client.38423ee9.js',
      '/_astro/index.45a47ed6.js',
    ],
  }),
  {
    pageMap: pageMap,
